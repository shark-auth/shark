...
**Do you have revenue?**
No. Revenue model post-YC is Supabase-shaped: OSS free forever self-hosted; paid hosted SharkAuth Cloud (starts at ~$29/mo per project for the tier that replaces Auth0's $53+ agent add-on); optional enterprise support contracts. Hosted tier blocked today on Postgres migration (single-node SQLite is a hard scaling ceiling).
